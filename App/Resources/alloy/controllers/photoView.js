function Controller() {
    ...
    back ? $.__views.__alloyId2.addEventListener("click", back) : __defers["$.__views.__alloyId2!click!back"] = true;
    ...
    $.__views.__alloyId3.add($.__views.imageMapContainer);
    ...
    $.__views.__alloyId4.add($.__views.caption);
    ...
    $.__views.__alloyId7.add($.__views.placeName);
    ...
    $.__views.__alloyId9.add($.__views.uploadDate);
    ...
    $.__views.__alloyId11.add($.__views.newThread);
    ...
    loadThreads();
    $.photoView.open();
    __defers["$.__views.__alloyId2!click!back"] && $.__views.__alloyId2.addEventListener("click", back);
